...
2. **Modify CLIP**: Modify the call to nn.MultiheadAttention in [model.py](https://github.com/openai/CLIP/blob/main/clip/model.py) to pass `need_weights=True` (to record attention weights). 
